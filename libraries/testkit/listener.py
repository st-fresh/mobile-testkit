...
# For use with any listener based application
class Listener:
...
class AndroidListener(Listener):
...
class iOSListener(Listener):

    def __init__(self):
        # Set listener url
        self.url = "http://{}:{}".format(self.get_host_ip(), 5984)
