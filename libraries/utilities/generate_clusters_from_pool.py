...
def generate_clusters_from_pool(pool_file):
    ...
    cluster_confs = [
        ...
        ClusterDef("1sg_1ac_1cbs_1lgs_1lbs", num_sgs=1, num_acs=1, num_cbs=1, num_lgs=1, num_lbs=1),
        ClusterDef("2sg_2ac_3cbs_1lgs", num_sgs=2, num_acs=2, num_cbs=3, num_lgs=1, num_lbs=0),
        ClusterDef("2sg_2ac_3cbs_1lgs_1lbs", num_sgs=2, num_acs=2, num_cbs=3, num_lgs=1, num_lbs=1),
