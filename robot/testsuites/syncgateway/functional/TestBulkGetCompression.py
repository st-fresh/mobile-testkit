...
class TestBulkGetCompression:

    def issue_request(self, target, user_agent, accept_encoding, x_accept_part_encoding, payload):
    ...
    def verify_response_size(self, user_agent, accept_encoding, x_accept_part_encoding, response_size):
    ...
    def test_bulk_get_compression(self, conf, num_docs, accept_encoding=None, x_accept_part_encoding=None, user_agent=None):
        ...
        response_size = self.issue_request(cluster.sync_gateways[0], user_agent, accept_encoding, x_accept_part_encoding, payload)
        log.info("Response size: {}".format(response_size))

        # Verfiy size matches expected size
        self.verify_response_size(user_agent, accept_encoding, x_accept_part_encoding, response_size)
