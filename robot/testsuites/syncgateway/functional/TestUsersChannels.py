...
class TestUsersChannels:
    ...
    def test_multiple_users_multiple_channels(self, conf):
    ...
    def test_muliple_users_single_channel(self, conf):
    ...
    def test_single_user_multiple_channels(self, conf):
    ...
    def test_single_user_single_channel(self, conf):
