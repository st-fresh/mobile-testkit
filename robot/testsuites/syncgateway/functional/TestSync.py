...
class TestSync:
    ...
    def test_issue_1524(self, conf, num_docs):
    ...
    def test_sync_access_sanity(self, conf):
    ...
    def test_sync_channel_sanity(self, conf):
    ...
    def test_sync_role_sanity(self, conf):
    ...
    def test_sync_sanity(self, conf):
    ...
    def test_sync_sanity_backfill(self, conf):
    ...
    def test_sync_require_roles(self, conf):
