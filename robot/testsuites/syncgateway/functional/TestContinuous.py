...
class TestContinuous:
    ...
    def test_continuous_changes_parametrized(self, conf, num_users, num_docs, num_revisions):
    ...
    def test_continuous_changes_sanity(self, conf, num_docs, num_revisions):
