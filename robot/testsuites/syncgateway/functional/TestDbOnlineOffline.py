...
class TestDbOnlineOffline:

    def rest_scan(self, sync_gateway, db, online, num_docs, user_name, channels):
    ...
    # Scenario 1
    def test_online_default_rest(self, conf, num_docs):
        ...
        errors = self.rest_scan(cluster.sync_gateways[0], db="db", online=True, num_docs=num_docs, user_name="seth", channels=["ABC"])
        assert(len(errors) == 0)
    ...
    # Scenario 2
    def test_offline_false_config_rest(self, conf, num_docs):
    ...
    # Scenario 3
    def test_online_to_offline_check_503(self, conf, num_docs):
        ...
        errors = self.rest_scan(cluster.sync_gateways[0], db="db", online=False, num_docs=num_docs, user_name="seth", channels=["ABC"])
    ...
    def test_online_to_offline_changes_feed_controlled_close_continuous(self, conf, num_docs):
    ...
    # Scenario 6 - longpoll
    def test_online_to_offline_continous_changes_feed_controlled_close_sanity_mulitple_users(self, conf, num_docs, num_users):
    ...
    # Scenario 6 - longpoll
    def test_online_to_offline_changes_feed_controlled_close_longpoll_sanity(self, conf, num_docs):
    ...
    # Scenario 6 - longpoll
    def test_online_to_offline_longpoll_changes_feed_controlled_close_sanity_mulitple_users(self, conf, num_docs, num_users):
    ...
    # Scenario 6 - longpoll
    def test_online_to_offline_changes_feed_controlled_close_longpoll(self, conf, num_docs):
    ...
    # Scenario 6
    def test_offline_true_config_bring_online(self, conf, num_docs):
    ...
    # Scenario 14
    def test_db_offline_tap_loss_sanity(self, conf, num_docs):
    ...
    # Scenario 11
    def test_db_delayed_online(self, conf, num_docs):
    ...
    def test_multiple_dbs_unique_buckets_lose_tap(self, conf, num_docs):
        ...
        for db in ["db2", "db4"]:
            errors = self.rest_scan(cluster.sync_gateways[0], db=db, online=True, num_docs=num_docs, user_name="adam", channels=["CBS"])
            assert(len(errors) == 0)
